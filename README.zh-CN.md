...
[![播放 45 秒 DSH-GPTLoop 产品演示](docs/assets/dsh-gptloop-demo-cover.png)](https://github.com/liangzhipengdamon-maker/GovernLoop-DSH/raw/main/docs/assets/dsh-gptloop-45s-demo.mp4)

*（点击缩略图播放 45 秒演示。背景音乐：PIXABAY。）*
