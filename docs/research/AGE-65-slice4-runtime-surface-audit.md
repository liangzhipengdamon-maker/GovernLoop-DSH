> **Historical decision evidence (archived 2026-08-24).** This document records a decision-input audit from the AGE-65 research phase. It is **NOT current runtime authority** — the current product boundary, code, and verification are described in the root README and `docs/verification/`.
